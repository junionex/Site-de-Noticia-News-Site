...
<div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
	  ...
	  <li class="nav-item">
		<div class="dropdown">
		  <button class="dropbtn" style="text-transform: uppercase;">menu</button>
			<div class="dropdown-content">
				<a href="#">Notícias</a>
				...
				<div id="pesquisar">
					<form method="GET" action='<?= site_url("noticias/noticiasPublicadas"); ?>' class="form-inline my-2 my-lg-0 pl-3-lg">
	...
	<div id="cadastroNoticia">
		<fieldset class="form-group">
			<legend id="legenda">Publicações</legend>
			<div id="tabela">
				<table class="table table-bordered table-dark">
					<div>
						<caption>
							<h4>
								<center>Notícias Publicadas</center>
							</h4>
						</caption>
					</div>
					<thead>
