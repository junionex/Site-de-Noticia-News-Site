...
<center><h2 style="color: red;">Sobre nós</h2></center>
<hr><br>
  <h4>Somos estudantes 
  do curso de Tecnologia em Análise e Desenvolvimento de Sistemas,
   do Instituto Federal de Educação,<br> Ciênca e Tecnologia do Rio Grande do Norte,
    Campus Nova Cruz/RN.</h4>

    <center><h2 style="color: red;">Missão</h2></center>
<hr><br>
  <h4>Nossa missão é desenvolver este site de notícias online.</h4>
